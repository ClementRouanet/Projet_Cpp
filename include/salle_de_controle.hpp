...
public:
  ...
  void affichageProdElec(sdl2::window& fenetre) const; // Affiche la production d'électricité (en MW)
  ...
  void afficheSystRefroidissement(sdl2::window& fenetre) const;  // Affiche la pression subit par l'enceinte de confinement
